...
class RussianStemmer:
    ...
    perfectiveground = u"((ив|ивши|ившись|ыв|ывши|ывшись)|" + \
        u"((?<=[ая])(в|вши|вшись)))$"
    reflexive = u"(с[яь])$"
    adjective = u"(ее|ие|ые|ое|ими|ыми|ей|ий|ый|ой|ем|им|ым|ом|его|" + \
        u"ого|ему|ому|их|ых|ую|юю|ая|яя|ою|ею)$"
    participle = u"((ивш|ывш|ующ)|((?<=[ая])(ем|нн|вш|ющ|щ)))$"
    verb = u"((ила|ыла|ена|ейте|уйте|ите|или|ыли|ей|уй|ил|ыл|им|ым|" + \
        u"ен|ило|ыло|ено|ят|ует|уют|ит|ыт|ены|ить|ыть|ишь|ую|ю)|((?<=[ая])" + \
        u"(ла|на|ете|йте|ли|й|л|ем|н|ло|но|ет|ют|ны|ть|ешь|нно)))$"
    noun = u"(а|ев|ов|ие|ье|е|иями|ями|ами|еи|ии|и|ией|ей|ой|ий|й|" + \
        u"иям|ям|ием|ем|ам|ом|о|у|ах|иях|ях|ы|ь|ию|ью|ю|ия|ья|я)$"
    rvre = u"^(.*?[аеиоуыэюя])(.*)$"
    derivational = u"[^аеиоуыэюя][аеиоуыэюя]+[^аеиоуыэюя]+" + \
        u"[аеиоуыэюя].*(?<=о)сть?$"
